...
INSERT INTO `pre_config` VALUES ('sitename', 'NAILTEAM');
INSERT INTO `pre_config` VALUES ('title', 'NAILTEAM - 专业聚合支付平台');
INSERT INTO `pre_config` VALUES ('keywords', 'NAILTEAM,聚合支付,免签约支付,支付宝,微信支付');
INSERT INTO `pre_config` VALUES ('description', 'NAILTEAM是专业聚合支付平台，完美解决支付难题，一站式接入支付宝，微信，财付通，QQ钱包,微信wap，帮助开发者快速集成到自己相应产品，效率高，见效快，费率低！');
...
INSERT INTO `pre_config` VALUES ('transfer_name', 'NAILTEAM');
INSERT INTO `pre_config` VALUES ('transfer_desc', 'NAILTEAM自动结算');
